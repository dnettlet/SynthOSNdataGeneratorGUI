...
import doCalcs.doCalcs;
import Dijkstra.AssignSeeds2;
import Dijkstra.FindMedoid;
...
public double RVp() 
{
	...
	//String nomFixterIn1    = "amazongraph.csv";  
	//String nomFixterIn2    = "amazoncommunities.csv";  
	//String nomFixterOut    = "amazon_out.csv"; 
	//String nomFixterOutg   = "amazon_outg.csv"; 
	//String nomFixterOut1   = "amazon_out1.csv"; 
	//String nomFixterOut2   = "amazon_out2.csv";
	
	//String nomFixterIn1    = "youtubegraph.csv";  
	//String nomFixterIn2    = "youtubecommunities.csv";  
	//String nomFixterOut    = "youtube_out.csv"; 
	//String nomFixterOutg   = "youtube_outg.csv"; 
	//String nomFixterOut1   = "youtube_out1.csv"; 
	//String nomFixterOut2   = "youtube_out2.csv"; 
	
	//String nomFixterIn1    = "livejournalgraph.csv";  
	//String nomFixterIn2    = "livejournalcommunities.csv";  
	//String nomFixterOut    = "livejournal_out.csv"; 
	//String nomFixterOutg   = "livejournal_outg.csv"; 
	//String nomFixterOut1   = "livejournal_out1.csv"; 
	//String nomFixterOut2   = "livejournal_out2.csv";
	
	//String nomFixterIn1    = "1kby30k.csv";  
	//String nomFixterIn2    = "1kby30kmodauthb.csv";  
	//String nomFixterOut    = "1kby30k_out.csv"; 
	//String nomFixterOutg   = "1kby30k_outg.csv";
	//String nomFixterOut1   = "1kby30k_out1.csv"; 
	//String nomFixterOut2   = "1kby30k_out2.csv";
	
	//String nomFixterIn1    = "rmatgraph.csv";  
	//String nomFixterIn2    = "rmatcommunities.csv";  
	//String nomFixterOut    = "rmat_out.csv"; 
	//String nomFixterOutg   = "rmat_outg.csv";
	//String nomFixterOut1   = "rmat_out1.csv"; 
	//String nomFixterOut2   = "rmat_out2.csv";
