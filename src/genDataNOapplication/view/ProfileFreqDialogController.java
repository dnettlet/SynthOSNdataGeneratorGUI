...
public class ProfileFreqDialogController {
    ...
    public void setup(List<Pair<List<Integer>,Integer>> profileList) {
    	sliderP0.setMin(0);    	sliderP0.setMax(500);	sliderP0.setBlockIncrement(1); 	
    	...
    	sliderP1.setMin(0);    	sliderP1.setMax(500);	sliderP1.setBlockIncrement(1);    	
    	...
    	sliderP2.setMin(0);    	sliderP2.setMax(500);	sliderP2.setBlockIncrement(1);       	
    	...
    	sliderP3.setMin(0);    	sliderP3.setMax(500);	sliderP3.setBlockIncrement(1);       	
    	...
    	sliderP4.setMin(0);    	sliderP4.setMax(500);	sliderP4.setBlockIncrement(1);       	
    	...
    	sliderP5.setMin(0);    	sliderP5.setMax(500);	sliderP5.setBlockIncrement(1);       	
    	...
    	sliderP6.setMin(0);    	sliderP6.setMax(500);	sliderP6.setBlockIncrement(1);       	
    	...
    	sliderP7.setMin(0);    	sliderP7.setMax(500);	sliderP7.setBlockIncrement(1);       	
    	...
    	sliderP8.setMin(0);    	sliderP8.setMax(500);	sliderP8.setBlockIncrement(1);       	
    	...
    	sliderP9.setMin(0);    	sliderP9.setMax(500);	sliderP9.setBlockIncrement(1);       	
